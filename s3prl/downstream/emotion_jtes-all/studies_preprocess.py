...
def main():
    ...
    out_dir = os.path.join(METADATA_PTAH, 'studies_meta_data')
    ...
    for filelist in filelists:
        ...
        with open(filelist, mode='r', encoding='utf-8') as f:
            ...
            for filepath in filepath_list:
                ...
                spk = os.path.splitext(os.path.basename(filepath))[0].split('-')[3]
    ...
    for wav_path in wavs:
        if '/ITA-' in wav_path:
            spk = os.path.splitext(os.path.basename(wav_path))[0].split('-')[2]
        else:
            spk = os.path.splitext(os.path.basename(wav_path))[0].split('-')[3]
